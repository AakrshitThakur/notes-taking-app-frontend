...
import { validateSignupForm } from "@/utils/functions/formValidation";
...
export default function Signup() {
  ...
  async function handleOnSubmit(e) {
    ...
    const signUpErrors = validateSignupForm(form);
  ...
  return (
    <section id="signup" className="h-[75vh] grid items-center mt-2">
      <React.Fragment>
        <CssBaseline />
          ...
          >
            <form onSubmit={handleOnSubmit}>
              ...
              <div>
                ...
                >
                  {isSubmitLoading ? "Please wait..." : "Signup"}
                </Button>
              </div>
            </form>
          </Box>
